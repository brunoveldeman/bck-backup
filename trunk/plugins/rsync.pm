	...
	$self->{_required} =	
				{
					...
					sourcelist=>"Comma separated list of sources to include in copy. Multiple entries can be used. Can be local or remote",
					dest=>"Destination. Can be local or remote"
				};
	$self->{_optional} = 	
				{ 	
